-- Originaly from https://github.com/jonstoler/lua-toml
-- I've added a tiny convenient function
...
---@param path string
---@param options? {string: boolean}
TOML.parse_file = function(path, options)
  local f = io.open(path)
  assert(f, 'cannot open file: ' .. path)
  local buf = f:read('a')
  f:close()
  return TOML.parse(buf, options)
end
