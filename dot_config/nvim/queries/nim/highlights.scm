...
; XXX(@solarizedalias): Disabled below as this isn't always true.
;                       For example, {.experimental: "caseStmtMacros".}
...
([
  ...
  (raw_string_literal)
  (generalized_string)
  ] @string (#set! "priority" 98))

; injections in generalized_strings
(generalized_string
  (string_content) @none (#set! "priority" 98))
